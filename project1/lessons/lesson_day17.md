# 100 Days of Swift — Dia 17

Fonte: https://www.hackingwithswift.com/100/17
...
## Subtopico: /read/1/4/building-a-detail-screen

Fonte: https://www.hackingwithswift.com/read/1/4/building-a-detail-screen

	Building a detail screen - a free Hacking with Swift tutorial
							Forums
							Learn
								 Start Here
								 Latest Articles
							...
							About
								 ...
								 Sponsor the site
														SUBSCRIBE
			WWDC26: Save 50% on my books and bundles! >>
                                < Previous: Designing our interface
                                 
                                Next: Loading images with UIImage >
                    Building a detail screen
...
Make sure the image view is selected.
Hold down the Ctrl key on your keyboard.
Press your mouse button down on the image view, but hold it down – don’t release it.
While continuing to hold down Ctrl and your mouse button, drag from the image view into your code – into the other assistant editor pane.
As you move your mouse cursor, you should see a blue line stretch out from the image view into your code. Stretch that line so that it points between class DetailViewController: UIViewController { and override func viewDidLoad() {.
...
That’s our detail screen complete – we’re done with Interface Builder for now, and can return to code. This also means we’re done with the assistant editor, so you can return to the full-screen editor by going to View > Standard Editor > Show Standard Editor.
                    ...
                    Thank you!
    {
      ...
      "headline": "Building a detail screen",
      "image": {
        "@type": "imageObject",
        "url": "https://www.hackingwithswift.com/files/logo-large.png"
        },
      ...
      "publisher": {
		...
		function toggleReadStatus(status) {
			$.ajax({
				type: "POST",
				url: "/read-status",
				data: { "url": "/read/1/4/building-a-detail-screen", "status": status },
			});
			$(".readStatusButton").hide();
			$(".readStatusChanged").show();
		}
...
## Subtopico: /read/1/5/loading-images-with-uiimage

Fonte: https://www.hackingwithswift.com/read/1/5/loading-images-with-uiimage
	...
	Loading images with UIImage - a free Hacking with Swift tutorial
							...
							About
								 ...
								 Sponsor the site
														SUBSCRIBE
			WWDC26: Save 50% on my books and bundles! >>
                                < Previous: Building a detail screen
                                 
                                Next: Final tweaks: hidesBarsOnTap and large titles >
                    Loading images with UIImage
...
Notice that we get a Back button in the navigation bar that lets us return back to ViewController. If you click and drag carefully, you’ll find you can create a swipe gesture too – click at the very left edge of the screen, then drag to the right, just as you would do with your thumb on a phone.
                    ...
                    Thank you!
    {
      ...
      "author": "Paul Hudson",
      "datePublished": "2021-03-11",
      "headline": "Loading images with UIImage",
      "image": {
        "@type": "imageObject",
        "url": "https://www.hackingwithswift.com/files/logo-large.png"
        },
      ...
      "publisher": {
		...
		function toggleReadStatus(status) {
			$.ajax({
				type: "POST",
				url: "/read-status",
				data: { "url": "/read/1/5/loading-images-with-uiimage", "status": status },
			});
			$(".readStatusButton").hide();
			$(".readStatusChanged").show();
		}
...
## Subtopico: /read/1/6/final-tweaks-hidesbarsontap-safe-area-margins

Fonte: https://www.hackingwithswift.com/read/1/6/final-tweaks-hidesbarsontap-safe-area-margins

	Final tweaks: hidesBarsOnTap and large titles - a free Hacking with Swift tutorial
							Forums
							Learn
								 Start Here
								 Latest Articles
							...
							About
								 ...
								 Sponsor the site
														SUBSCRIBE
			WWDC26: Save 50% on my books and bundles! >>
                                < Previous: Loading images with UIImage
...
That’s all it takes – the large titles should behave properly now.
                    ...
                    Thank you!
    {
      ...
      "author": "Paul Hudson",
      "datePublished": "2021-03-11",
      "headline": "Final tweaks: hidesBarsOnTap and large titles",
      "image": {
        "@type": "imageObject",
        "url": "https://www.hackingwithswift.com/files/logo-large.png"
        },
      ...
      "publisher": {
		...
		function toggleReadStatus(status) {
			$.ajax({
				type: "POST",
				url: "/read-status",
				data: { "url": "/read/1/6/final-tweaks-hidesbarsontap-and-large-titles", "status": status },
			});
			$(".readStatusButton").hide();
			$(".readStatusChanged").show();
		}
